...
// ==========================================
// ALPHABETICAL SORTING UTILITY (New)
// ==========================================
function sortDataAlphabetically(data) {
    return data.sort((a, b) => {
        // Keep master at top always
...
function initDropdowns() {
    const populate = (id, data, ph) => {
        ...
        // Sort before populating dropdowns
...
function renderCheckboxes(sl, sc){ 
    ...
    b(sortedLists,sl,'check-lists'); 
    b(sortedCats,sc,'check-cats'); 
}
